...
from app.ingestion.dune import ingest_new_wallets, ingest_priority_fees, ingest_pumpfun_launch_stats
...
async def run_backfill(
    ...
    results["pumpfun_launch_stats"] = await ingest_pumpfun_launch_stats(engine, http_client)
