...
class NarrativeToken(Base):
    ...
    mcap_ath: Mapped[float | None] = mapped_column(Float, nullable=True)
...
class Narrative(Base):
    ...
    total_mcap: Mapped[float] = mapped_column(Float, default=0)
    avg_mcap: Mapped[float] = mapped_column(Float, default=0)
